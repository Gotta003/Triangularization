...
/**
  ...
  * @brief   Peer to peer Client Application - Master Sniffer Mode
  ******************************************************************************
  * @attention
  *
...
/* USER CODE END P2PC_APP_Init_1 */
  ...
  APP_DBG_MSG("-- P2P CLIENT INITIALIZED (MASTER SNIFFER MODE) \n");
#endif
...
/* Forza il recupero e reinnesca la scansione passiva quando la finestra scade */
void Force_Infinite_Scan(void)
{
